...
class Evaluator:
    def __init__(self, opt, projection_mode="orthogonal"):
        ...
        # set cuda
        cuda = (
            torch.device("cuda:%d" % opt.gpu_id)
    ...
    def eval(self, data, use_octree=False):
        ...
        with torch.no_grad():
            ...
            if self.netC:
                ...
                gen_mesh(
                    opt, self.netG, self.cuda, data, save_path, use_octree=use_octree
                )
...
if __name__ == "__main__":
    ...
    test_images = [
        f for f in test_images if ("png" in f or "jpg" in f) and (not "mask" in f)
    ]
